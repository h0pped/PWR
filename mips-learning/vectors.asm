...
#The sparse vector in its simplest version can be stored in memory as a pair of vectors - a value vector and an order vector with the same number of dimensions. More memory-saving solutions will be scored higher.
